...
<body>
	<div id="main-layout" class="easyui-layout" fit="true">
		<div data-options="region:'north',split:true" style="height: 50px;"><jsp:include
				page="north.jsp" /></div>
		<div data-options="region:'west',title:'<fmt:message key="global.system.lt.navi" />',split:true"
			style="width: 200px;"><jsp:include page="west.jsp" /></div>
		<div data-options="region:'east',split:true,collapsed:true" title="<fmt:message key="global.system.lt.detail" />"
			style="width: 300px;">
