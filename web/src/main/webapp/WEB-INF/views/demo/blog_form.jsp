...
<body>
	<c:if test="${showFormType eq 'create'}">
		<c:set var="ACTIONURL" value="${ctx}/demo/blog.do?method=create" />
	</c:if>
	<c:if test="${showFormType eq 'update'}">
		<c:set var="ACTIONURL" value="${ctx}/demo/blog.do?method=update" />
	</c:if>
