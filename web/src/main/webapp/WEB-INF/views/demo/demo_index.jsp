		...
		<div data-options="region:'west',title:'<fmt:message key="demo.lt.title" />',split:true"
			...
			<ul id="demo-lt-ul" class="easyui-tree">
				...
				<li><span><fmt:message key="demo.lt.title.dg" /></span>
					<ul>
						<li><span><a href="javascript:void(0)"
								onclick="openTab4Demo('demo-tab-dg-base','<fmt:message key="demo.lt.title.dg.base" />','<c:url value="/demo/datagrid.do?method=dg4base"/>')"><fmt:message key="demo.lt.title.dg.base" /></a></span></li>
								<li><span><a href="javascript:void(0)"
								onclick="openTab4Demo('demo-tab-dg-tb','<fmt:message key="demo.lt.title.dg.tb" />','<c:url value="/demo/datagrid.do?method=dg4tb"/>')"><fmt:message key="demo.lt.title.dg.tb" /></a></span></li>
								<li><span><a href="javascript:void(0)"
								onclick="openTab4Demo('demo-tab-dg-export','<fmt:message key="demo.lt.title.dg.export" />','<c:url value="/demo/datagrid.do?method=dg4export"/>')"><fmt:message key="demo.lt.title.dg.export" /></a></span></li>
					</ul></li>
