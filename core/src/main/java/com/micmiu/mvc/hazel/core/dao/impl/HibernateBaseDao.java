package com.micmiu.mvc.hazel.core.dao.impl;
...
import com.micmiu.mvc.hazel.core.dao.BaseDao;
...
public abstract class HibernateBaseDao<E, ID extends Serializable> implements
		BaseDao<E, ID> {
	 ...
	 * @return Hibernate Query
	 */
	protected Query buildQuery(final String hql,
			final Map<String, Object> paraMaps) {
		Query q = getSession().createQuery(hql);
		if (paraMaps != null) {
			for (Map.Entry<String, Object> entry : paraMaps.entrySet()) {
