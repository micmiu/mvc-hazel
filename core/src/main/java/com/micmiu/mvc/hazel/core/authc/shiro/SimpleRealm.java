...
import com.micmiu.mvc.hazel.core.action.CaptchaServlet;
import com.micmiu.mvc.hazel.core.action.exception.CaptchaException;
...
import com.micmiu.mvc.hazel.core.service.ShiroRealmService;
...
public class SimpleRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		return new SimpleAuthenticationInfo(new ShiroUser(info[0], info[1]),
				info[2], getName());
	...
	protected AuthorizationInfo doGetAuthorizationInfo(
		...
		List<IPermission> permissions = shiroRealmService
		...
		if (null != permissions) {
			...
			for (IPermission p : permissions) {
				...
				logger.debug(">>>Permssion:" + p.getPermOperation());
			}
			// 基于Permission的权限信息
